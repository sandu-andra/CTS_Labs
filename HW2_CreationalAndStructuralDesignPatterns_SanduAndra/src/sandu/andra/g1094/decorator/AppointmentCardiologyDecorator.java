...
public class AppointmentCardiologyDecorator extends AppointmentDecorator{

	public AppointmentCardiologyDecorator(DoctorApp doctor) {
		super(doctor);
	}
	...
	public void consultPatient() {
		...
		System.out.println("Inside cardiology department.");
	}
