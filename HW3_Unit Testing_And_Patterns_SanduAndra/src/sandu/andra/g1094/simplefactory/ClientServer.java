...
public class ClientServer implements ServerInterface{
	...
	public ClientServer(String serverIpAddress, int serverPort, int maximumConnections,
			boolean isConnected) {
		super();
		this.serverName = "Client Server";
